...
export type UserRole = 'PM' | 'PM_MANAGER' | 'DESIGNER' | 'DESIGN_HEAD' | 'UX_WRITER' | 'DEVELOPER';
...
export type WorkflowStage = 'PRODUCT_THINKING' | 'USER_RESEARCH' | 'UX_DESIGN' | 'UI_DESIGN' | 'VISUAL_DESIGN' | 'UX_CONTENT' | 'CODE_EXPORT';
...
export interface ResearchData {
    ...
    personas: Persona[];
    insights: Insight[];
    status: 'PLANNED' | 'IN_PROGRESS' | 'COMPLETED' | 'PENDING_APPROVAL' | 'APPROVED';
...
export interface Approval {
    id: string;
    type: 'PRD' | 'RESEARCH' | 'DESIGN' | 'UI' | 'CODE';
